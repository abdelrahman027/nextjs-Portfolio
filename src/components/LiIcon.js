...
const LiIcon = ({ reference }) => {
    ...
    return (
        <figure className='absolute -left-4 sm:-left-0 stroke-dark dark:stroke-light'>
            <svg width='75' height='75' viewBox='0 0 100 100' className='-rotate-90 sm:w-[60px] sm:h-[60px] xs:w-[40px] xs:h-[40px]' >
